...
# The weights_init function is typically for training, not inference,
# so it's excluded for a leaner inference-only model definition.
# If you need it for some specific reason (e.g., re-initializing weights before loading state_dict),
# you can re-add it.
# def weights_init(m):
